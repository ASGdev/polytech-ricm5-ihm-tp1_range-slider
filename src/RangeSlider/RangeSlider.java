...
public class RangeSlider extends Control {
    ...
    /**
     * The current infValue represented by this Slider. This value must
     ...
     */
    private DoubleProperty infValue;
    public final void setInfValue(double value) {
        if (!infValueProperty().isBound()) infValueProperty().set(value);
    }

    public final double getInfValue() {
        return infValue == null ? 0 : infValue.get();
    }

    public final DoubleProperty infValueProperty() {
        if (infValue == null) {
            infValue = new DoublePropertyBase(0) {
                @Override protected void invalidated() {
                    adjustValues();
     ...
     */
    private BooleanProperty infValueChanging;

    public final void setInfValueChanging(boolean value) {
        infValueChangingProperty().set(value);
    }

    public final boolean isInfValueChanging() {
        return infValueChanging == null ? false : infValueChanging.get();
    }

    public final BooleanProperty infValueChangingProperty() {
        if (infValueChanging == null) {
            infValueChanging = new SimpleBooleanProperty(this, "infValueChanging", false);
        }
        return infValueChanging;
    }
    
    /**
     * The current supValue represented by this Slider. This value must
     * always be between {@link #minProperty() min} and {@link #maxProperty() max},
     * inclusive. If it is ever out of bounds either due to {@code min} or
     * {@code max} changing or due to itself being changed, then it will
     * be clamped to always remain valid.
     */
    private DoubleProperty supValue;
    public final void setSupValue(double value) {
        if (!supValueProperty().isBound()) supValueProperty().set(value);
    }

    public final double getSupValue() {
        return supValue == null ? 0 : supValue.get();
    }

    public final DoubleProperty supValueProperty() {
        if (supValue == null) {
            supValue = new DoublePropertyBase(0) {
                @Override protected void invalidated() {
                    adjustValues();
                    notifyAccessibleAttributeChanged(AccessibleAttribute.VALUE);
                }
     ...
     * computed, it is reset back to false.
     */
    private BooleanProperty supValueChanging;

    public final void setSupValueChanging(boolean value) {
        supValueChangingProperty().set(value);
    }

    public final boolean isSupValueChanging() {
        return supValueChanging == null ? false : supValueChanging.get();
    }

    public final BooleanProperty supValueChangingProperty() {
        if (supValueChanging == null) {
            supValueChanging = new SimpleBooleanProperty(this, "supValueChanging", false);
        }
        return supValueChanging;
    }
...
//    //    public def span = bind max - min;
    ...
    public final ObjectProperty<Orientation> orientationProperty() {
        if (orientation == null) {
            orientation = new StyleableObjectProperty<Orientation>(Orientation.HORIZONTAL) {
                ...
                @Override
                public CssMetaData<RangeSlider,Orientation> getCssMetaData() {
    ...
    public final BooleanProperty showTickLabelsProperty() {
        if (showTickLabels == null) {
            showTickLabels = new StyleableBooleanProperty(false) {
                ...
                @Override
                public CssMetaData<RangeSlider,Boolean> getCssMetaData() {
    ...
    public final DoubleProperty majorTickUnitProperty() {
        if (majorTickUnit == null) {
            majorTickUnit = new StyleableDoubleProperty(25) {
                ...
                @Override
                public CssMetaData<RangeSlider,Number> getCssMetaData() {
     ...
     */
    public void adjustInfValue(double newValue) {
    ...
    public void adjustSupValue(double newValue) {
        // figure out the "value" associated with the specified position
        final double _min = getMin();
        final double _max = getMax();
        if (_max <= _min) return;
    ...
    /**
     * Increments the inf value by {@link #blockIncrementProperty() blockIncrement}, bounded by max. If the
     * max is less than or equal to the min, then this method does nothing.
     */
    public void incrementInf() {
        adjustInfValue(getInfValue() + getBlockIncrement());
    }
    
    /**
     * Increments the sup value by {@link #blockIncrementProperty() blockIncrement}, bounded by max. If the
     * max is less than or equal to the min, then this method does nothing.
     */
    public void incrementSup() {
        adjustSupValue(getSupValue() + getBlockIncrement());
    }

    /**
     * Decrements the inf value by {@link #blockIncrementProperty() blockIncrement}, bounded by max. If the
     * max is less than or equal to the min, then this method does nothing.
     */
    public void decrementInf() {
        adjustInfValue(getInfValue() - getBlockIncrement());
    }
    
    /**
     * Decrements the sup value by {@link #blockIncrementProperty() blockIncrement}, bounded by max. If the
     * max is less than or equal to the min, then this method does nothing.
     */
     ...
     * somewhere between the two and inf is always <= max and sup is always >= inf, and that if snapToTicks is set then the
